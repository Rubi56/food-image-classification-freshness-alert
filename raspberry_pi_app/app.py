...
<html>
<head>
    <title>Freshness Alert System</title>
    <style>
        body {
            font-family: Arial;
...
<body>
    <div class="box">
        <h2>AI-Powered Freshness Alert System</h2>
...
Your Raspberry Pi Freshness Alert System detected a banana.
...
This alert was automatically generated by your AI-Powered Freshness Alert System.
"""
...
def index():
    ...
    if request.method == "POST":
        ...
        if item == "banana" or item_confidence < LOW_CONFIDENCE_LIMIT:
            ...
            if item == "banana" or banana_stage_confidence >= BANANA_SAFETY_CONFIDENCE:
                if item != "banana":
                    corrected = True

                item = "banana"
                item_confidence = max(item_confidence, banana_stage_confidence)
        ...
        message = f"This is a {item}. It is a {category.lower()}."
